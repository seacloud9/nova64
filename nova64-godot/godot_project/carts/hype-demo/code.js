...
export function draw() {
  ...
  drawPanel(4, 4, 220, 22, {
    bgColor: rgba8(0, 0, 12, 210),
    borderLight: cCyan,
    borderDark: rgba8(0, 60, 80),
  });
  print(`HYPE: ${labels[section]}`, 8, 10, cWhite);

  // Section counter badge
  drawPanel(W - 48, 4, 44, 22, {
    bgColor: rgba8(0, 0, 12, 210),
    borderLight: cGrey,
    borderDark: rgba8(30, 40, 70),
  });
  print(`${section + 1}/11`, W - 42, 10, cGrey);

  // Nav hint
  print('SPACE: next', W - 82, H - 22, rgba8(80, 90, 110));
