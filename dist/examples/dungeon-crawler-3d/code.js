...
export const env = {
  meta: {
    name: 'Dungeon Delve 3D',
    version: '1.0.0',
    author: 'Nova64',
    description: 'Roguelike dungeon crawler with themed floors and boss fights',
  },

  text: {
    defaultLocale: 'en',
    strings: {
      'game.title': 'DUNGEON DELVE 3D',
      'game.subtitle': 'Into the Depths',
      'enemy.slime': 'Slime',
      ...
      'boss.goblin_king': 'Goblin King',
      'boss.shadow_lord': 'Shadow Lord',
      'boss.bone_dragon': 'Bone Dragon',
      'item.gold': 'Gold',
      'item.potion': 'Potion',
      'hud.floor': 'Floor',
      'hud.hp': 'HP',
    ...
    locales: {
      es: {
        'game.title': 'DUNGEON DELVE 3D',
        'game.subtitle': 'Hacia las Profundidades',
        'enemy.slime': 'Slime',
        'enemy.skeleton': 'Esqueleto',
        'enemy.demon': 'Demonio',
        'enemy.ghost': 'Fantasma',
        'boss.goblin_king': 'Rey Goblin',
        'boss.shadow_lord': 'Señor de las Sombras',
        'boss.bone_dragon': 'Dragón de Hueso',
        'item.gold': 'Oro',
        'item.potion': 'Poción',
        'hud.floor': 'Piso',
        'hud.hp': 'PV',
  ...
  entities: {
    enemies: {
      slime: { name: 'enemy.slime', hp: 6, atk: 2, def: 0, xp: 5, color: 0x44ff44, tier: 1, shape: 'slime' },
      skeleton: { name: 'enemy.skeleton', hp: 10, atk: 4, def: 1, xp: 10, color: 0xddddaa, tier: 1, shape: 'skeleton' },
      demon: { name: 'enemy.demon', hp: 14, atk: 6, def: 2, xp: 20, color: 0xff3333, tier: 2, shape: 'demon' },
      ghost: { name: 'enemy.ghost', hp: 8, atk: 5, def: 0, xp: 15, color: 0x8888ff, tier: 2, shape: 'ghost' },
      lich: { name: 'enemy.lich', hp: 18, atk: 8, def: 3, xp: 30, color: 0xaa44ff, tier: 3, shape: 'lich' },
      dragon_whelp: { name: 'enemy.dragon_whelp', hp: 25, atk: 10, def: 4, xp: 50, color: 0xff8800, tier: 3, shape: 'dragon' },
    },
    bosses: {
      goblin_king: { name: 'boss.goblin_king', hp: 40, atk: 8, def: 3, xp: 80, color: 0x88ff44, shape: 'boss' },
      shadow_lord: { name: 'boss.shadow_lord', hp: 60, atk: 10, def: 4, xp: 120, color: 0x6622cc, shape: 'boss' },
      bone_dragon: { name: 'boss.bone_dragon', hp: 80, atk: 12, def: 5, xp: 200, color: 0xffcc44, shape: 'boss' },
    },
  },

  items: {
    gold: { name: 'item.gold', type: 'currency', stackable: true, rarity: 'common' },
    potion: { name: 'item.potion', type: 'consumable', effect: { heal: 15 }, stackable: true, rarity: 'common' },
  },
  ...
  defaults: {
    fog: { enabled: true, color: 0x0a0a18, near: 4, far: 20 },
    lighting: { ambient: 0xccccee, ambientIntensity: 0.12 },
    effects: {
      bloom: { strength: 0.6, radius: 0.3, threshold: 0.4 },
      vignette: { darkness: 1.2, offset: 0.9 },
    },
  },

  levels: {
    stone_crypt: { fog: { color: 0x0a0a18 }, lighting: { ambient: 0xccccee }, accent: 0x6666aa, torchColor: 0xff8833 },
    mossy_sewer: { fog: { color: 0x081008 }, lighting: { ambient: 0x88ddaa }, accent: 0x44aa66, torchColor: 0x66ff88 },
    bone_catacombs: { fog: { color: 0x100c08 }, lighting: { ambient: 0xeeddcc }, accent: 0xccaa88, torchColor: 0xffaa44 },
    frozen_depths: { fog: { color: 0x0a1020 }, lighting: { ambient: 0xaaccff }, accent: 0x88bbff, torchColor: 0x44ccff },
    inferno_pits: { fog: { color: 0x180808 }, lighting: { ambient: 0xff8866 }, accent: 0xff4422, torchColor: 0xff3300 },
    the_void: { fog: { color: 0x08041a }, lighting: { ambient: 0xcc88ff }, accent: 0xaa44ff, torchColor: 0xdd55ff },
  },
};
