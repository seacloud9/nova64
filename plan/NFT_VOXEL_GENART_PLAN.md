...
- Predefined shapes: cube, slab*bottom, slab_top, stair*\_, slope\_\_, fence, wall
...
Add to examples/generative-art/code.js (6→14 scenes): 7. Reaction-Diffusion — Gray-Scott cellular automata, coral patterns 8. Fractal Tree — L-system branching, seasonal animation, wind 9. Voronoi Stained Glass — drifting seeds, jewel-tone filled cells 10. Mandelbrot Zoom — deep zoom, smooth iteration coloring 11. Particle Cloth — Verlet integration 30×30 cloth sim 12. Strange Attractors — Lorenz/Rössler 3D projected trails 13. Circle Packing — progressive fill, size-based coloring 14. Pixel Sorting — glitch art, brightness-sorted pixel bands
