// hello-namespaced — first real Nova64 cart ported to the Godot host.
//
// Source: examples/hello-namespaced/code.js (unchanged).
// Runs against the Godot QuickJS bridge via the nova64-compat shim
// (see godot_project/shim/nova64-compat.js).
