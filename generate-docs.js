...
const pages = [
  {
    ...
    overview:
      'The 3D Graphics API provides comprehensive 3D rendering capabilities using Three.js. Create primitive shapes (cubes, spheres, planes), load GLB/GLTF models, manage materials with PBR properties, and control lighting and shadows.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Sprite System handles 8×8 pixel sprite rendering with sprite sheet support. Load sprite sheets, draw individual sprites with flipping and scaling, and render tilemaps for level design.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Skybox API creates immersive space backgrounds with procedural star fields, colored nebulae, and galaxy effects. Perfect for space games and sci-fi demos.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Visual Effects API adds post-processing shaders for cinematic visuals. Apply bloom glow, chromatic aberration, CRT scanlines, and anti-aliasing.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Voxel Engine provides a Minecraft-style block world system. Create and manipulate voxel terrain with efficient chunk-based rendering and collision detection.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Physics Engine provides arcade-style physics simulation. Create physics bodies with gravity, velocity, friction, and automatic tilemap collision resolution.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Collision Detection API provides utilities for detecting overlaps between game objects. Test AABB rectangles, circles, and perform tilemap raycasts.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Storage API wraps browser localStorage for easy game state persistence. Save high scores, settings, and player progress.',
    features: [
  ...
  },
  {
    ...
    overview:
      'The Screen Manager handles game states like title screen, gameplay, pause menu, and game over. Each screen has its own init, update, and draw functions.',
    features: [
