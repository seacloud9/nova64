...
export function draw() {
  ...
  // Uppercase
  nova64.draw.print('UPPERCASE: ABCDEFGHIJKLMNOPQRSTUVWXYZ', 20, 35, nova64.draw.rgba8(255, 255, 255, 255), 1);

  // Lowercase
  nova64.draw.print('lowercase: abcdefghijklmnopqrstuvwxyz', 20, 52, nova64.draw.rgba8(0, 255, 200, 255), 1);
  ...
  nova64.draw.print('           <>=+*&%$#@^~`"|\\/', 20, 103, nova64.draw.rgba8(255, 150, 255, 255), 1);

  // Arrows (Unicode)
  nova64.draw.print('Arrows:    ← → ↑ ↓ ↔ ↕', 20, 120, nova64.draw.rgba8(100, 255, 100, 255), 1);
  nova64.draw.print('Controls:  ↑↓ UP/DOWN  ←→ LEFT/RIGHT', 20, 137, nova64.draw.rgba8(200, 200, 255, 255), 1);

  // Mixed case examples
  nova64.draw.print('Mixed:     Hello World! The Quick Brown Fox', 20, 154, nova64.draw.rgba8(255, 200, 150, 255), 1);
  nova64.draw.print('           Jumps Over The Lazy Dog 123!', 20, 171, nova64.draw.rgba8(255, 200, 150, 255), 1);

  // Emoji handling (should strip or replace)
  nova64.draw.print('Emoji Test: 🎮 🚀 ⚡ ✨ (cleaned automatically)', 20, 195, nova64.draw.rgba8(255, 100, 100, 255), 1);
  ...
  nova64.draw.print('  Press X to Fire! Press Z for Boost!', 20, 270, nova64.draw.rgba8(200, 200, 200, 255), 1);
  ...
  nova64.draw.print('✅ All Characters Rendering Correctly!', 35, 303, nova64.draw.rgba8(0, 255, 100, 255), 1);
  nova64.draw.print('No more ??? for lowercase, arrows, or emojis!', 35, 320, nova64.draw.rgba8(150, 255, 150, 255), 1);
}
