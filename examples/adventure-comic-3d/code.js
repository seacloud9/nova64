...
export function init() {
  ...
  // ── Floor ──────────────────────────────────────────────────────────────────
  const floor = createPlane(20, 20, 0x2a1800, [0, 0, 0],
...
export function draw() {
  if (state === 'title') {
    ...
    // Speaker badge
    const speakerColor = speaker === 'Detective' ? 0x3355cc
                       : speaker === 'Suspect'   ? 0xcc2222
                       :                           0x228844;
