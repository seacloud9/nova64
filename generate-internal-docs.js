...
const pages = [
    {
        ...
        overview: 'The Console System (Nova64 class) is the main runtime that loads game cartridges, manages the update/draw loop, handles screen transitions, and coordinates all subsystems.',
        features: [
    ...
    },
    {
        ...
        overview: 'The Framebuffer provides direct pixel access for 2D rendering. It stores a 640×360 array of pixels and provides methods for direct pixel manipulation.',
        features: [
    ...
    },
    {
        ...
        overview: 'The Font System provides bitmap font rendering with a built-in 8×8 pixel font. It handles text drawing with color support.',
        features: [
    ...
    },
    {
        ...
        overview: 'The Asset Loader handles loading and caching of game assets including images, sprite sheets, tilemaps, sounds, and 3D models.',
        features: [
    ...
    },
    {
        ...
        overview: 'The Sprite Editor is a built-in tool for creating and editing 8×8 pixel sprites. It provides a color palette and drawing tools.',
        features: [
    ...
    },
    {
        ...
        overview: 'The Text Input system handles keyboard text entry for UI text fields, chat boxes, and other text input needs.',
        features: [
    ...
    },
    {
        ...
        overview: 'Nova64 uses multiple GPU backends for rendering: Three.js for 3D graphics, WebGL2 for advanced effects, and Canvas2D as a fallback.',
        features: [
