...
// ============================================================================
// App Store — registered apps registry
// ============================================================================
...
// ============================================================================
// Window Store — active app overlay
// ============================================================================
...
const savedTheme = ((): Theme => {
  try {
    const v = localStorage.getItem('emobile-theme');
...
export const useThemeStore = create<ThemeStore>((set) => ({
  ...
  toggle: () =>
    set((state) => {
      ...
      try { localStorage.setItem('emobile-theme', next); } catch { /* ignore */ }
      document.documentElement.setAttribute('data-theme', next);
      return { theme: next };
    }),

  setTheme: (t) => {
    try { localStorage.setItem('emobile-theme', t); } catch { /* ignore */ }
