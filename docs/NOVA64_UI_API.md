...
```javascript
// Create button
const button = createButton(x, y, width, height, 'Click Me', () => {
...
const healthColor = health > 50 ? uiColors.success :
                    health > 25 ? uiColors.warning :
                    uiColors.danger;
...
export async function init() {
  ...
  // Create menu buttons
  ui.menuButtons.push(
    createButton(centerX(100), 200, 100, 40, 'START', () => {
      console.log('Game started!');
    }, { normalColor: uiColors.success })
  );
  
  ui.menuButtons.push(
    createButton(centerX(100), 250, 100, 40, 'OPTIONS', () => {
      console.log('Options opened!');
    }, { normalColor: uiColors.primary })
  );
  
  ui.menuButtons.push(
    createButton(centerX(100), 300, 100, 40, 'QUIT', () => {
...
*Now with first-class UI system!*
