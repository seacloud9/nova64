...
export async function runIntegrationTests() {
  ...
  runner.test('3D API - Global Function Availability', () => {
    ...
    const expectedFunctions = [
      ...
      'destroyMesh', 'setPosition', 'setRotation', 'setScale',
      'setCameraPosition', 'setCameraTarget', 'setCameraFOV',
      'setFog', 'setLightDirection', 'setLightColor', 'setAmbientLight',
  ...
  runner.test('Screen System - Global Function Availability', () => {
    ...
    const expectedFunctions = [
      'addScreen', 'switchToScreen', 'getCurrentScreen', 'startScreens'
    ];
  ...
  runner.test('Main.js Integration - API Exposure', () => {
    ...
    const mockApis = {
      stdApi: () => ({ exposeTo: (target) => { target.cls = () => {}; target.print = () => {}; } }),
      spriteApi: () => ({ exposeTo: (target) => { target.sprite = () => {}; } }),
      threeDApi: () => ({ 
        exposeTo: (target) => { 
          target.createCube = () => {};
  ...
  runner.test('Performance - API Function Calls', async () => {
    ...
    const { average } = await Performance.benchmark('3D API calls', () => {
